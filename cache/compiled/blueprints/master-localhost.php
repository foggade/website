...
return [
    ...
    'timestamp' => 1461510294,
    'checksum' => '9a64704dee34a5a681cb57094f7227a7',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/piwik' => [
                'file' => 'user/plugins/piwik/blueprints.yaml',
                'modified' => 1450361556
            ],
            'plugins/form' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.piwik.enabled' => [
                ...
                'name' => 'plugins.piwik.enabled'
            ],
            'plugins.piwik.siteId' => [
                'type' => 'text',
                'size' => 'medium',
                'label' => 'site ID',
                'placeholder' => 0,
                'help' => 'piwik tracking ID. In format integer.',
                'name' => 'plugins.piwik.siteId'
            ],
            'plugins.piwik.sitePiWikURL' => [
                'type' => 'text',
                'label' => 'url piwik',
                'size' => 'medium',
                'placeholder' => 'http://example.com/privacy-url',
                'help' => 'Add url piwik',
                'name' => 'plugins.piwik.sitePiWikURL'
            ],
            'plugins.form' => [
                'type' => '_parent',
                'name' => 'plugins.form'
        ...
        'nested' => [
            'plugins' => [
                ...
                'piwik' => [
                    'enabled' => 'plugins.piwik.enabled',
                    'siteId' => 'plugins.piwik.siteId',
                    'sitePiWikURL' => 'plugins.piwik.sitePiWikURL'
                ],
                'form' => [
